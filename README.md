...
- SKU: 21843-The trend was very stable over the first 22 months, but it surged to £1.34k in Dec. 2011.Under normal circumstances, the supply and demand for this product are extremely stable; however, during the Black Friday promotion in November, a sudden surge in traffic caused severe, instantaneous overselling or necessitated logistical interception. This constitutes a "systemic logistics failure during peak periods."
...
- Product of At Risk Segment: As the price band analysis before, band 1-4.99 takes up the majority of canceled revenue share, so this band requires close attention, and i excluded other bands,like <1, 5-9.99 and 10-19.99. In this band, 85123A account for the most canceled revenue, and 22138 and 22617 have high cancel rate. Therefore,i made a reveue trend for 85123A and quality trend for 22138 and 22617 from Jan. 2010 to Dec. 2011.
...
- Actionable Insights for Product in At Risk Segment
- Customer Churn Driven by Stockouts (Diagnosis): Data reveals that the primary reason high-value, long-term customers (the "At-Risk" segment) churned was not a loss of interest in the brand. Instead, a systemic stockout of the core traffic-driving product (Model 85123A) during a standard month (April 2011) caused a spike in churn-related revenue loss exceeding £5,000. This disruption severely damaged the VIP purchasing journey, ultimately undermining retention rates during the critical Q4 peak sales season.
- Dynamic ERP Control (Implementation): For high-frequency impulse or traffic-driving products—where the £1.00–£4.99 price bracket accounts for 72.6% of churn-related revenue loss—the supply chain team must move beyond ad-hoc restocking in November and December. Instead, they must establish a dynamic, automated safety stock alert mechanism within the ERP system.
- KPI Alignment (Cross-Departmental Collaboration): Incorporate "regular-month inventory turnover and stockout rates" for these core SKUs into the supply chain's annual KPIs. By shifting the defensive line to the off-season, the team can eliminate the churn trigger at its source, thereby safeguarding potential net revenue for the Q4 peak season.
