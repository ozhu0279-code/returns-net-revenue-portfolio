...
## Deep Dive
- **Scale & Trend**In this section,i splited into 2 categories--all products(revenue trend) and product-only(revenue and quality trend,AOV,UPO and ASP trend,top5 orders per month by order amount).
