...
- Cancellation Rate--It means canceled_orders divided by all_orders.
- Net Revenue--It means that gross revenue minus canceled revenue.
...
- For time-series KPI trends (orders, cancellation rate, canceled revenue share), we keep all transactions including missing CustomerID to avoid selection bias.
