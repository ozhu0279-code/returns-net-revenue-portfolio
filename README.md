...
- From sku scatter plot,we can see that there are 5 products,which are over £3,000 for canceled revenue.From price band table,the band-1-4.99 is a high risk bar
