...
- **SKU / Price band**：We made a sku scatter diagram to clearly find the  of skus combined cancel rate and order volume,and it was divded into 4 quadrants which are fix now,investigate,star and investigate and stable.In this diagram,the high-risk skus are located at fix now quadrant and counted up to 38 products,which is over 90 percentile in order volum--541 and average cancel rate--4.04%.
